import { __add, __div, __isEqual, __isGreaterThan, __isGreaterThanEquals, __isLessThan, __isLessThanEquals, __isNegative, __isZero, __max, __min, __mul, __sub, __toBigInt, __toCommaSeparated, __toCompactNumber, __toInteger, __toPercent, __trimDecimalPlaces } from "./helper.js";
// STRING
...
String.prototype.trimDecimalPlaces = function (decimalPlaces) {
...
Number.prototype.trimDecimalPlaces = function (decimalPlaces) {
    return __trimDecimalPlaces(this.toString(), decimalPlaces);
};
// BIG INTEGER
...
BigInt.prototype.trimDecimalPlaces = function (decimalPlaces) {
    return __trimDecimalPlaces(this.toString(), decimalPlaces);
};
