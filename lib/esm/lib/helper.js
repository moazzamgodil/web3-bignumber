...
export const formatting = (number) => normalizeNumericInput(number);
...
export const __toBig = (num, decimals = 18) => shiftDecimal(num, decimals);
...
export const __toPercent = (num) => __mul(num, 100).concat("%");
/** Returns true when numeric value is exactly zero. */
export const __isZero = (num) => parseDecimal(num).int === 0n;
...
export const __isGreaterThanEquals = (num, num2) => __isGreaterThan(num, num2) || __isEqual(num, num2);
/** Returns true when `num` is less than `num2`. */
export const __isLessThan = (num, num2) => !__isGreaterThanEquals(num, num2);
/** Returns true when `num` is less than or equal to `num2`. */
export const __isLessThanEquals = (num, num2) => !__isGreaterThan(num, num2);
...
export const __sub = (num, num2) => __add(num, parseDecimal(num2).sign === -1 ? normalizeNumericInput(num2).slice(1) : `-${normalizeNumericInput(num2)}`);
...
export const __max = (num, num2) => __isGreaterThan(num, num2) ? formatting(num) : formatting(num2);
/** Returns the smaller of two numeric values as a normalized decimal string. */
export const __min = (num, num2) => __isLessThan(num, num2) ? formatting(num) : formatting(num2);
